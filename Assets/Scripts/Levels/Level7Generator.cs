...
/// <summary>
/// Generates Level 7 - Simple fixed level with 5 lightning bolts
/// </summary>
public class Level7Generator : MonoBehaviour
{
    ...
    void CreateFixedLevel()
    {
        ...
        CreateBoxBlock(new Vector3(11f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(11.5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        ...
        CreateLightningBolt(new Vector3(11.25f * blockSize, 0.5f + 1.5f, 0f));
