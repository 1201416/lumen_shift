...
/// <summary>
/// Generates Level 7 - Medium-High Challenge
/// Increased complexity with Mushroom and Skeleton monsters
/// </summary>
public class Level7Generator : MonoBehaviour
{
    [Header("Level Settings")]
    public float blockSize = 1f;
    public int totalFloorBlocks = 90; // Level 7: Medium-High level (90 blocks)
    ...
    void Start()
    {
        ...
        if (levelManager != null && levelManager.currentLevel != 7)
        {
    ...
    public void GenerateLevel7()
    {
        ...
        Debug.Log("Level 7 generated successfully!");
    }
    ...
    void PlaceMonsters()
    {
        // Level 7: Mushroom + Skeleton (9 total monsters)
        PlaceMushroomMonstersOnGrass();
        PlaceSkeletonMonsters();
    }
    
    /// <summary>
    /// Place Flying Eye monsters - Not used in Level 7
    /// </summary>
    ...
    /// <summary>
    /// Place Goblin monsters - Not used in Level 7
    /// </summary>
    ...
    /// <summary>
    /// Place Skeleton monsters - Level 7: 5 Skeleton
    /// </summary>
    void PlaceSkeletonMonsters()
    {
        // Level 7: 5 Skeleton monsters on ground (distributed across 90 blocks)
        CreateMonster(new Vector3(18f, 0.7f, 0f), Monster.MonsterType.Skeleton);
        CreateMonster(new Vector3(35f, 0.8f, 0f), Monster.MonsterType.Skeleton);
        CreateMonster(new Vector3(55f, 0.7f, 0f), Monster.MonsterType.Skeleton);
    ...
    void PlaceMushroomMonstersOnGrass()
    {
        ...
        int maxMushrooms = 4; // Level 7: 4 Mushroom monsters (to total 13-14 with other types)
    ...
    void SetupWinnerScreen()
    {
        ...
        if (existingWinnerScreen == null)
        {
            ...
            winnerScreen.SetCurrentLevel(7);
        }
    }
