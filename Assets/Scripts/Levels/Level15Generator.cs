...
/// <summary>
/// Generates Level 15 - Simple fixed level with 9 lightning bolts (FINAL LEVEL)
/// </summary>
public class Level15Generator : MonoBehaviour
{
    ...
    private int levelLength = 60; // Fixed length

    void Start()
    {
        LevelManager levelManager = FindFirstObjectByType<LevelManager>();
        if (levelManager != null && levelManager.currentLevel != 15)
        {
    ...
    public void GenerateLevel15()
    {
        ...
        Debug.Log("Level 15 generated successfully!");
    }
    ...
    void CreateFixedLevel()
    {
        ...
        CreateBoxBlock(new Vector3(9f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(10f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(12f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(12.5f * blockSize, 9f, 0f), visibleDuringDay: false);
        ...
        CreateBoxBlock(new Vector3(17f * blockSize, 12f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(17.5f * blockSize, 12f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(18f * blockSize, 12f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(20f * blockSize, 10.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(21f * blockSize, 12f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(22f * blockSize, 13.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(23f * blockSize, 15f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(25f * blockSize, 15f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(25.5f * blockSize, 15f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(26f * blockSize, 15f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(26.5f * blockSize, 15f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(29f * blockSize, 13.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(29.5f * blockSize, 13.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(32f * blockSize, 12f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(32.5f * blockSize, 12f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(35f * blockSize, 10.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(35.5f * blockSize, 10.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(38f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(39f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(40f * blockSize, 6f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(41f * blockSize, 4.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(43f * blockSize, 4.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(43.5f * blockSize, 4.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(44f * blockSize, 4.5f, 0f), visibleDuringDay: false);

        // Place monsters on platforms:
        CreateMonster(new Vector3(7f * blockSize, 4.5f + 0.5f, 0f), Monster.MonsterType.Mushroom);
        CreateMonster(new Vector3(13f * blockSize, 9f + 0.5f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(18f * blockSize, 12f + 0.5f, 0f), Monster.MonsterType.Mushroom);
        CreateMonster(new Vector3(23f * blockSize, 15f + 0.5f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(32.5f * blockSize, 12f + 0.5f, 0f), Monster.MonsterType.Mushroom);
        CreateMonster(new Vector3(40f * blockSize, 6f + 0.5f, 0f), Monster.MonsterType.FlyingEye);

        // Place 9 lightning bolts - ONLY reachable by climbing/platforming:
        // Bolt 1: Requires platforming
        CreateLightningBolt(new Vector3(10f * blockSize, 10.5f, 0f));
        // Bolt 2: Requires platforming
        CreateLightningBolt(new Vector3(13f * blockSize, 11f, 0f));
        // Bolt 3: Requires platforming
        CreateLightningBolt(new Vector3(18f * blockSize, 13.5f, 0f));
        // Bolt 4: Requires platforming
        CreateLightningBolt(new Vector3(23f * blockSize, 16.5f, 0f));
        // Bolt 5: Requires platforming
        CreateLightningBolt(new Vector3(26f * blockSize, 17f, 0f));
        // Bolt 6: Requires platforming
        CreateLightningBolt(new Vector3(32.5f * blockSize, 13.5f, 0f));
        // Bolt 7: Requires platforming
        CreateLightningBolt(new Vector3(35.5f * blockSize, 12.0f, 0f));
        // Bolt 8: Requires platforming
        CreateLightningBolt(new Vector3(40f * blockSize, 7.5f, 0f));
        // Bolt 9: Requires platforming
        CreateLightningBolt(new Vector3(44f * blockSize, 6.0f, 0f));
    ...
    void SetupWinnerScreen()
    {
        ...
        if (existingWinnerScreen == null)
        {
            ...
            winnerScreen.SetCurrentLevel(15);
        }
    }
