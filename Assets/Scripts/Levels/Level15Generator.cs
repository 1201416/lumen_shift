...
public class Level15Generator : MonoBehaviour
{
    ...
    void CreateFixedLevel()
    {
        ...
        CreateBoxBlock(new Vector3(37f * blockSize, 1.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(37.5f * blockSize, 1.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(41f * blockSize, 1.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(41.5f * blockSize, 1.5f, 0f), visibleDuringDay: false);
        ...
        CreateLightningBolt(new Vector3(37.25f * blockSize, 1.5f + 1.5f, 0f));
