...
public class Level15Generator : MonoBehaviour
{
    ...
    void CreateFixedLevel()
    {
        ...
        CreateBoxBlock(new Vector3(5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(5.5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(9f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(9.5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(13f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(13.5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(17f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(17.5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        ...
        CreateBoxBlock(new Vector3(25f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(25.5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(29f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(29.5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(33f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(33.5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(37f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(37.5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(41f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(41.5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        ...
        CreateLightningBolt(new Vector3(5.25f * blockSize, 0.5f + 1.5f, 0f));
        CreateLightningBolt(new Vector3(9.25f * blockSize, 0.5f + 1.5f, 0f));
        CreateLightningBolt(new Vector3(13.25f * blockSize, 0.5f + 1.5f, 0f));
        CreateLightningBolt(new Vector3(17.25f * blockSize, 0.5f + 1.5f, 0f));
        CreateLightningBolt(new Vector3(21.25f * blockSize, 0.5f + 1.5f, 0f));
        CreateLightningBolt(new Vector3(25.25f * blockSize, 0.5f + 1.5f, 0f));
        CreateLightningBolt(new Vector3(29.25f * blockSize, 0.5f + 1.5f, 0f));
        CreateLightningBolt(new Vector3(33.25f * blockSize, 0.5f + 1.5f, 0f));
        CreateLightningBolt(new Vector3(37.25f * blockSize, 0.5f + 1.5f, 0f));
