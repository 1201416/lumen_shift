...
public class Level8Generator : MonoBehaviour
{
    ...
    public int totalFloorBlocks = 100; // Level 8: 100 blocks
    ...
    void PlaceLightningBolts()
    {
        ...
        int boltsToPlace = 6; // Level 8: 6 lightning bolts
        int placed = 0;
        int attempts = 0;
        int maxAttempts = 300;
    ...
    void PlaceMonsters()
    {
        // Level 8: Goblin + Skeleton (10 total monsters)
        PlaceGoblinMonsters();
        PlaceSkeletonMonsters();
    }
    
    /// <summary>
    /// Place Flying Eye monsters - Not used in Level 8
    /// </summary>
    ...
    /// <summary>
    /// Place Goblin monsters - Level 8: 5 Goblin
    /// </summary>
    void PlaceGoblinMonsters()
    {
        // Level 8: 5 Goblin monsters on ground (distributed across 100 blocks)
        CreateMonster(new Vector3(20f, 0.8f, 0f), Monster.MonsterType.Goblin);
        CreateMonster(new Vector3(35f, 0.9f, 0f), Monster.MonsterType.Goblin);
        CreateMonster(new Vector3(55f, 0.8f, 0f), Monster.MonsterType.Goblin);
        CreateMonster(new Vector3(75f, 0.9f, 0f), Monster.MonsterType.Goblin);
        CreateMonster(new Vector3(90f, 0.8f, 0f), Monster.MonsterType.Goblin);
    }
    
    /// <summary>
    /// Place Skeleton monsters - Level 8: 5 Skeleton
    /// </summary>
    void PlaceSkeletonMonsters()
    {
        // Level 8: 5 Skeleton monsters on ground (distributed across 100 blocks)
        CreateMonster(new Vector3(15f, 0.7f, 0f), Monster.MonsterType.Skeleton);
        CreateMonster(new Vector3(40f, 0.8f, 0f), Monster.MonsterType.Skeleton);
        CreateMonster(new Vector3(60f, 0.7f, 0f), Monster.MonsterType.Skeleton);
        CreateMonster(new Vector3(80f, 0.8f, 0f), Monster.MonsterType.Skeleton);
        CreateMonster(new Vector3(95f, 0.7f, 0f), Monster.MonsterType.Skeleton);
    }
    
    void PlaceMushroomMonstersOnGrass()
    {
        // Level 8: Not using Mushroom monsters
        FloorBlock[] allFloorBlocks = FindObjectsByType<FloorBlock>(FindObjectsSortMode.None);
        List<Vector3> grassBlockPositions = new List<Vector3>();
