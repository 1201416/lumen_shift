...
/// <summary>
/// Generates Level 14 - Simple fixed level with 8 lightning bolts
/// </summary>
public class Level14Generator : MonoBehaviour
{
    ...
    private int levelLength = 55; // Fixed length

    void Start()
    {
        LevelManager levelManager = FindFirstObjectByType<LevelManager>();
        if (levelManager != null && levelManager.currentLevel != 14)
        {
    ...
    public void GenerateLevel14()
    {
        ...
        Debug.Log("Level 14 generated successfully!");
    }
    ...
    void CreateFixedLevel()
    {
        ...
        // Maze pattern - up down left right
        ...
        CreateBoxBlock(new Vector3(11f * blockSize, 6f, 0f), visibleDuringDay: false);
        ...
        CreateBoxBlock(new Vector3(15f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(16f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(18f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(18.5f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(19f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(19.5f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(21f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(22f * blockSize, 6f, 0f), visibleDuringDay: false);
        ...
        CreateBoxBlock(new Vector3(26f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(27f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(28f * blockSize, 10.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(29f * blockSize, 12f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(31f * blockSize, 12f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(31.5f * blockSize, 12f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(32f * blockSize, 12f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(34f * blockSize, 10.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(35f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(36f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(38f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(38.5f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        ...
        CreateMonster(new Vector3(10.5f * blockSize, 6f + 0.5f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(15.5f * blockSize, 7.5f + 0.5f, 0f), Monster.MonsterType.Mushroom);
        CreateMonster(new Vector3(19f * blockSize, 9f + 0.5f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(23f * blockSize, 4.5f + 0.5f, 0f), Monster.MonsterType.Mushroom);
        CreateMonster(new Vector3(29f * blockSize, 12f + 0.5f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(36f * blockSize, 7.5f + 0.5f, 0f), Monster.MonsterType.Mushroom);

        // Place 7 lightning bolts - ONLY reachable by climbing/platforming:
        // Bolt 1: Requires platforming
        CreateLightningBolt(new Vector3(8f * blockSize, 7.5f, 0f));
        // Bolt 2: Requires platforming
        CreateLightningBolt(new Vector3(10.5f * blockSize, 8f, 0f));
        // Bolt 3: Requires platforming
        CreateLightningBolt(new Vector3(16f * blockSize, 10.5f, 0f));
        // Bolt 4: Requires platforming
        CreateLightningBolt(new Vector3(19f * blockSize, 11f, 0f));
        // Bolt 5: Requires platforming
        CreateLightningBolt(new Vector3(27f * blockSize, 10.5f, 0f));
        // Bolt 6: Requires platforming
        CreateLightningBolt(new Vector3(29f * blockSize, 13.5f, 0f));
        // Bolt 7: Requires platforming
        CreateLightningBolt(new Vector3(38.5f * blockSize, 9.0f, 0f));
    ...
    void SetupWinnerScreen()
    {
        ...
        if (existingWinnerScreen == null)
        {
            ...
            winnerScreen.SetCurrentLevel(14);
        }
    }
