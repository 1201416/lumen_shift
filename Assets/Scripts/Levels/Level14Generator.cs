...
public class Level14Generator : MonoBehaviour
{
    ...
    public int totalFloorBlocks = 185; // Level 14: 185 blocks
    ...
    void PlaceLightningBolts()
    {
        ...
        int boltsToPlace = 9; // Level 14: 9 lightning bolts
        int placed = 0;
        int attempts = 0;
        int maxAttempts = 300;
    ...
    void PlaceMonsters()
    {
        // Level 14: All monster types (16 total monsters)
    ...
    /// <summary>
    /// Place Flying Eye monsters - Level 14: 4 FlyingEye
    /// </summary>
    void PlaceFlyingEyeMonsters()
    {
        // Level 14: 4 FlyingEye monsters (distributed across 185 blocks)
        CreateMonster(new Vector3(30f, 2.5f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(70f, 2.8f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(120f, 2.6f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(160f, 2.7f, 0f), Monster.MonsterType.FlyingEye);
    }
    
    /// <summary>
    /// Place Goblin monsters - Level 14: 4 Goblin
    /// </summary>
    void PlaceGoblinMonsters()
    {
        // Level 14: 4 Goblin monsters on ground
        ...
        CreateMonster(new Vector3(110f, 0.8f, 0f), Monster.MonsterType.Goblin);
        CreateMonster(new Vector3(150f, 0.9f, 0f), Monster.MonsterType.Goblin);
    }
    
    /// <summary>
    /// Place Skeleton monsters - Level 14: 4 Skeleton
    /// </summary>
    void PlaceSkeletonMonsters()
    {
        // Level 14: 4 Skeleton monsters on ground
        CreateMonster(new Vector3(20f, 0.7f, 0f), Monster.MonsterType.Skeleton);
        CreateMonster(new Vector3(75f, 0.8f, 0f), Monster.MonsterType.Skeleton);
        CreateMonster(new Vector3(130f, 0.7f, 0f), Monster.MonsterType.Skeleton);
        CreateMonster(new Vector3(170f, 0.8f, 0f), Monster.MonsterType.Skeleton);
    }
    ...
    void PlaceMushroomMonstersOnGrass()
    {
        ...
        int maxMushrooms = 4; // Level 14: 4 Mushroom monsters (to total 13-14 with other types)
