...
/// <summary>
/// Generates Level 10 - Simple fixed level with 6 lightning bolts
/// </summary>
public class Level10Generator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (levelManager != null && levelManager.currentLevel != 10)
        {
    ...
    public void GenerateLevel10()
    {
        ...
        Debug.Log("Level 10 generated successfully!");
    }
    ...
    void CreateFixedLevel()
    {
        ...
        // Stepped pyramid - wide platforms
        ...
        CreateBoxBlock(new Vector3(11f * blockSize, 3f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(12f * blockSize, 3f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(13f * blockSize, 3f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(15f * blockSize, 4.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(16f * blockSize, 4.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(17f * blockSize, 4.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(18f * blockSize, 4.5f, 0f), visibleDuringDay: false);
        ...
        CreateBoxBlock(new Vector3(25f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(26f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(27f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(28f * blockSize, 7.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(30f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(30.5f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(31f * blockSize, 9f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(31.5f * blockSize, 9f, 0f), visibleDuringDay: false);

        // Place monsters on platforms:
        CreateMonster(new Vector3(7f * blockSize, 1.5f + 0.5f, 0f), Monster.MonsterType.Mushroom);
        CreateMonster(new Vector3(12f * blockSize, 3f + 0.5f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(17f * blockSize, 4.5f + 0.5f, 0f), Monster.MonsterType.Mushroom);
        CreateMonster(new Vector3(23f * blockSize, 6f + 0.5f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(28f * blockSize, 7.5f + 0.5f, 0f), Monster.MonsterType.Mushroom);

        // Place 5 lightning bolts - ONLY reachable by climbing/platforming:
        // Bolt 1: Requires platforming
        CreateLightningBolt(new Vector3(12f * blockSize, 4.5f, 0f));
        // Bolt 2: Requires platforming
        CreateLightningBolt(new Vector3(18f * blockSize, 6.0f, 0f));
        // Bolt 3: Requires platforming
        CreateLightningBolt(new Vector3(23f * blockSize, 7.5f, 0f));
        // Bolt 4: Requires platforming
        CreateLightningBolt(new Vector3(28f * blockSize, 9.0f, 0f));
        // Bolt 5: Requires platforming
        CreateLightningBolt(new Vector3(31f * blockSize, 10.5f, 0f));
    ...
    void SetupWinnerScreen()
    {
        ...
        if (existingWinnerScreen == null)
        {
            ...
            winnerScreen.SetCurrentLevel(10);
        }
    }
