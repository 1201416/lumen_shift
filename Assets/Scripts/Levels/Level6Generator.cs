...
/// <summary>
/// Generates Level 6 - Medium-High Challenge
/// Increased complexity with more monsters and platforms
/// </summary>
public class Level6Generator : MonoBehaviour
{
    [Header("Level Settings")]
    public float blockSize = 1f;
    public int totalFloorBlocks = 80; // Level 6: Medium-High level (80 blocks)
    ...
    void PlaceLightningBolts()
    {
        ...
        int boltsToPlace = 5; // Level 6: 5 lightning bolts
        int placed = 0;
        int attempts = 0;
        int maxAttempts = 300;
    ...
    void PlaceMonsters()
    {
        // Level 5: All monster types (13-14 total monsters)
    ...
    /// <summary>
    /// Place Flying Eye monsters - Level 5: 3-4 FlyingEye
    /// </summary>
    void PlaceFlyingEyeMonsters()
    {
        // Level 5: 3-4 FlyingEye monsters (in middle of passages)
        CreateMonster(new Vector3(30f, 6.0f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(60f, 8.0f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(90f, 7.0f, 0f), Monster.MonsterType.FlyingEye);
        CreateMonster(new Vector3(110f, 6.5f, 0f), Monster.MonsterType.FlyingEye);
    }
    
    /// <summary>
    /// Place Goblin monsters - Level 5: 3-4 Goblin
    /// </summary>
    void PlaceGoblinMonsters()
    {
        // Level 5: 3-4 Goblin monsters on ground (in middle of passages)
        CreateMonster(new Vector3(20f, 0.8f, 0f), Monster.MonsterType.Goblin);
        CreateMonster(new Vector3(50f, 0.9f, 0f), Monster.MonsterType.Goblin);
        CreateMonster(new Vector3(80f, 0.8f, 0f), Monster.MonsterType.Goblin);
        CreateMonster(new Vector3(105f, 0.9f, 0f), Monster.MonsterType.Goblin);
    }
    
    /// <summary>
    /// Place Skeleton monsters - Level 5: 3-4 Skeleton
    /// </summary>
    void PlaceSkeletonMonsters()
    {
        // Level 5: 3-4 Skeleton monsters on ground (in middle of passages)
        CreateMonster(new Vector3(25f, 0.7f, 0f), Monster.MonsterType.Skeleton);
        CreateMonster(new Vector3(55f, 0.8f, 0f), Monster.MonsterType.Skeleton);
        CreateMonster(new Vector3(85f, 0.7f, 0f), Monster.MonsterType.Skeleton);
    }
    
    void PlaceMushroomMonstersOnGrass()
    {
        // Level 6: Not using Mushroom monsters
        FloorBlock[] allFloorBlocks = FindObjectsByType<FloorBlock>(FindObjectsSortMode.None);
        List<Vector3> grassBlockPositions = new List<Vector3>();
        ...
        int maxMushrooms = 3; // Limit to 3 mushrooms for Level 5 (to total 13-14 with other types)
