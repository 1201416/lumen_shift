...
public class Level6Generator : MonoBehaviour
{
    ...
    void CreateFixedLevel()
    {
        ...
        CreateBoxBlock(new Vector3(19f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        CreateBoxBlock(new Vector3(19.5f * blockSize, 0.5f, 0f), visibleDuringDay: false);
        ...
        CreateLightningBolt(new Vector3(19.25f * blockSize, 0.5f + 1.5f, 0f));
